(function() {
  window.onload = function() {
    ...
    btn1.onclick = function() {
      ...
      block4Cont.innerHTML = '<h4>Ekstrakt ploda crne bazge<br><p>Sambucus nigra</p></h4>\n' +
    ...
    btn2.onclick = function() {
      ...
      block4Cont.innerHTML = '<h4>Ekstrakt korijena ljekovite pelargonije<br><p>Pelargonium sidoides</p></h4>\n' +
          '<p>\n' +
    ...
    btn3.onclick = function() {
      ...
      block4Cont.innerHTML = '<h4>Yestimun<sup>®</sup> beta glukan</h4>\n' +
          '<p>' +
