...
//////// block-4
      ...
      rightArrow1.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Hepar sulfuris</b>  – має протизапальну дію при хронічному перебігу хвороби. Сприяє очищенню лакун від патологічного вмісту, загоєнню наривів³</p>';
      ...
      rightArrow3.onclick = function () {
          ...
          block4Cont.innerHTML = '<p><b>Mercurius bijodatus</b>  – знімає набряк і запалення лімфатичних вузлів, покращує лімфодренаж, сприяє очищенню лакун, зменшенню гіпертрофії мигдаликів³</p>';
